...
export class Scrollbox extends PIXI.Container {
  ...
  constructor(options = {}) {
    ...
    this.ease =
      typeof this.options.fadeScrollboxEase === 'function'
    ...
    this.addChild = function () {
      return this.content.addChild(...arguments);
    };

    this.removeChild = function () {
      return this.content.removeChild(...arguments);
    };
  }
  ...
  updateLoop(elapsed) {
    if (this.fade) {
      ...
      if (this.fade.duration >= this.options.fadeScrollbarTime) {
        ...
        this.scrollbar.alpha = this.ease(
          this.fade.duration,
          1,
          -1,
          this.options.fadeScrollbarTime
        );
      }
